            ...
            <div class="container">
                ...
                <div class="national-grid-frontend-charts">
                    <div class="national-grid-frontend-chart-wrap">
                        <canvas class="national-grid-frontend-chart national-grid-frontend-chart-pie"
                                aria-label="<?php esc_attr_e('National Grid pie chart', 'national-grid'); ?>"
                                role="img"></canvas>
                    </div>
                    <div class="national-grid-frontend-chart-wrap">
                        <canvas class="national-grid-frontend-chart national-grid-frontend-chart-bar"
                                aria-label="<?php esc_attr_e('National Grid bar chart', 'national-grid'); ?>"
                                role="img"></canvas>
                    </div>
                </div>
                <div class="national-grid-frontend-legend"
                     aria-label="<?php esc_attr_e('Chart legend', 'national-grid'); ?>"></div>
